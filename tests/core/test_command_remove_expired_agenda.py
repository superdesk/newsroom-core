...
from newsroom.commands.remove_expired_agenda import has_plan_expired, _get_expired_chain_ids, remove_expired_agenda
...
def test_get_expired_chain_ids(app):
    ...
    assert _get_expired_chain_ids(event2, expiry_datetime) == ["event2", "plan3", "plan4"]
