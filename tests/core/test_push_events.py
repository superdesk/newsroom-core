...
test_event: Dict[str, Any] = {
    ...
    "calendars": [{"name": "Sport", "qcode": "sport", "is_active": True}],
    ...
    "location": [
        {
            "location": {"lat": -33.8548157, "lon": 151.2164539},
    ...
    "links": ["www.earthhour.com"],
    "_current_version": 1,
    "subject": [{"name": "ecosystem", "qcode": "06002002", "parent": "06002000"}],
...
text_item = {
    ...
    "wordcount": 1,
    "slugline": "something",
    "firstpublished": "2020-08-06T06:00:59+0000",
    "language": "en",
    "priority": 6,
    "version": "2",
    "body_html": "<p>Body</p>",
    "charcount": 4,
    "versioncreated": "2020-08-06T06:00:24+0000",
    "genre": [{"code": "Backgrounder", "name": "Backgrounder"}],
    "firstcreated": "2020-08-06T05:59:39+0000",
...
def test_push_coverages_with_different_dates_for_an_existing_event(client, app):
    ...
    assert parsed["display_dates"][1]["date"].isoformat() == planning["coverages"][1]["planning"]["scheduled"].replace(
        "0000", "00:00"
    )
...
def test_coverages_delivery_sequence_has_default(client, app):
    ...
    planning["guid"] = "bar7"
    planning["event_item"] = "foo7"
    planning["coverages"][0]["deliveries"] = [{"item_id": "item7", "item_state": "published", "sequence_no": None}]
    planning["coverages"][0]["workflow_status"] = "completed"
