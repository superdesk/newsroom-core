                ...
                >
                    ...
                    >
                        <span className={classNames('coverage-item__coverage-icon', WORKFLOW_COLORS[coverage.workflow_status])}>
                            ...
                            <span>{`${coverage.genre !== null && coverage.genre?.length !==0 ? gettext(coverage.genre[0].name) : getCoverageDisplayName(coverage.coverage_type)}${getSlugline(coverage)}`}</span>
                        </span>
