    ...
    return (
        <form onSubmit={save}>
            <div className="nh-flex-container list-item__preview-form pt-0">
                ...
                <div className="nh-flex__row">
                    <FormSection initiallyOpen={true} name={gettext('Email Notifications:')} testId="topic-form-group--notifications">
                        <div>
                    ...
                    <FormSection initiallyOpen={true} name={gettext('Organize your Topic')} testId="topic-form-group--folder">
                ...
                <div className="nh-flex__row">
                    <FormSection initiallyOpen={true} name={gettext('Topic details')} testId="topic-form-group--params">
