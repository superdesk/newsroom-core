 ...
 * @param {Object} item
 */
export function getLocations(item: any): any {
 ...
 * @return {Array}
 */
export function getGeoLocations(locations: any): any {
 ...
 * @return {Object}
 */
export function getAddress(item: any): any {
 ...
 * @return {Array}
 */
export function getBoundingBox(location: any): any {
 ...
 * @return {String}
 */
export function getAddressLine(location: any): any {
 ...
 * @param {Object} location
 */
export function getAddressState(location: any): any {
 ...
 * @param {Object} location
 */
export function getAddressCountry(location: any): any {
 ...
 */
export function getBounds(location: any): any {
 ...
 */
export function getLatLng(location: any): any {
    return {
...
export function mapsLoaded(): any {
    return window.mapsLoaded;
}

export function mapsKey(): any {
 ...
 * @param {Object} location
 */
function getZoom(location: any): any {
...
function getLocationDetails(location: any): any {
...
export function getMapSource(locations: any,  scale = 1): any {
    ...
    if (google_maps_styles) {
        const styles = google_maps_styles.split('&').filter((s: any) => s).map((s) => `style=${s}`);
...
export function shouldRenderLocation(item: any): any {
