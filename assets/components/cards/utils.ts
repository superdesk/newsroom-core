...
const getCard = memoize((cardId: any) => CARD_TYPES.find((card: any) => card._id === cardId));
const getCardEditComponent: any = (cardId: any) => get(getCard(cardId), 'editComponent', ConfigProduct);
