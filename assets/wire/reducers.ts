...
function recieveAggs(state: any, data: any): any {
    return {
        ...state,
...
function markItemsRemoved(state: any, ids: any): any {
...
function _wireReducer(state: any, action: any): any {
    switch (action.type) {
...
export default function wireReducer(state = initialState, action: any): any {
    switch (action.type) {
