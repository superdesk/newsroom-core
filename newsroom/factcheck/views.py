...
async def index():
    ...
    return render_template("factcheck_index.html", data=data, user_profile_data=user_profile_data)
...
async def bookmarks():
    ...
    data["bookmarks"] = True
    user_profile_data = await get_user_profile_data()
    return render_template("factcheck_bookmarks.html", data=data, user_profile_data=user_profile_data)
